...
$site_top = "http://www.product-lynx.jp/";
...
$thanksPage = "http://www.product-lynx.jp/thanks.html";
...
$require = array('会社名','担当者名','メールアドレス','電話番号');
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	...
	$adminBody .="「プロダクト・リンクス｜オフィシャルサイト」からお問合せがありました\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
